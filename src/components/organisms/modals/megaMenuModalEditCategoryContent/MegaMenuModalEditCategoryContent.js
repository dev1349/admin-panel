...
const MegaMenuModalEditCategoryContent = ({ open, onClose, itemIdForEdition, baseUrl, onOpenErrorModal }) => {
    ...
    const isError = isCategoryError || isNewMegaMenuItemAddError || isItemError
...
export default MegaMenuModalEditCategoryContent
