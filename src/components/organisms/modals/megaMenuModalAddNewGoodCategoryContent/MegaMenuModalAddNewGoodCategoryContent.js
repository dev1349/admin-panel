...
const MegaMenuModalAddNewGoodCategoryContent = ({ open, onClose, itemsCount = 0, parentItem, baseUrl, onOpenErrorModal }) => {
...
export default MegaMenuModalAddNewGoodCategoryContent
