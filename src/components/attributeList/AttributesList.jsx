...
export const AttributesList = (props) => (
    ...
    <div className={props.showComp}>
        <div className={"attributes-list attributes-list-header-color"}>
            ...
            <div onClick={() => props.sortFunc('name')} className={props.getClassName('name')}>
                {'Название'}
            </div>
            <div onClick={() => props.sortFunc('group')} className={props.getClassName('group')}>
                {'Група'}
            </div>
            <div onClick={() => props.sortFunc('sortingOrder')} className={props.getClassName('sortingOrder')}>
                {'Порядок сортировки'}
            </div>
            <div>
                {'Действия'}
