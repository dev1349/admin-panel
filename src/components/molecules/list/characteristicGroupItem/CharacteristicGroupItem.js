...
const CharacteristicGroupItem = ({
    ...
    const isGroupCharacteristicInSet = characteristicId =>
        isCharacteristicGroupInSet(characteristicGroup.id) ? true : isCharacteristicInSet(characteristicId)
            ...
            <Box flexGrow1>
                <FlexTemplate alignItemsCenter gap7>
                    ...
                    <FlexTemplate alignItemsCenter gap10>
                        <Switch
                            name={`switch${characteristicGroup.id}`}
                            dialogSwitch
                            disableRipple
                            checked={isCharacteristicGroupInSet(characteristicGroup.id)}
                            onChange={addRemoveCharacteristicGroupInSet(characteristicGroup)}
                        />
                    </FlexTemplate>
                </FlexTemplate>
                {hasCharacteristics(characteristicGroup) && (
                                                ...
                                                <FlexTemplate spaceBetween alignItemsCenter gap10>
                                                    ...
                                                    <FlexTemplate alignItemsCenter gap10>
                                                        <Switch
                                                            ...
                                                            dialogSwitch
                                                            disableRipple
                                                            checked={isGroupCharacteristicInSet(characteristic.id)}
                                                            onChange={addRemoveCharacteristicInSetGroup(
                                                                characteristic,
                                                                characteristicGroup
                                                            )}
                                                            disabled={isCharacteristicGroupInSet(characteristicGroup.id)}
                                                        />
...
export default CharacteristicGroupItem
