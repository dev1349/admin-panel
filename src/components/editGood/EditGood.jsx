...
export const EditGood = () => (
    <form>
        ...
        <div>
            ...
            <div>
                <input type="button" onClick={() => document.execCommand('italic',false,null)}
                        title="Italicize Highlighted Text" value={"I"}/>

                <input type="button" onClick={ () => document.execCommand( 'bold',false,null)}
                        title="Bold Highlighted Text" value="B"/>

                <input type="button"  onClick={ () => document.execCommand( 'underline',false,null)}
                    value="U" title="Underline Highlighted Text"
                />
