...
const LeverageStyled = createStyled('LeverageIconStyle', 'svg')

const LeverageIcon = props => {
    return (
        <LeverageStyled width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            <path
