...
export const POST_STYLE_PATH = SERVER_PATH + '/api/postStyle'
export const GET_STYLE_PATH = SERVER_PATH + '/api/getStyle'
export const GET_ALL_STYLE_PATH = SERVER_PATH + '/api/getAllStyle'
export const PUT_STYLE_PATH = SERVER_PATH + '/api/putStyle'
export const DELETE_STYLE_PATH = SERVER_PATH + '/api/deleteStyle'
