...
const CHARACTERISTICS_WITHOUT_GROUP = '/without-group'
export const CHARACTERISTICS_WITHOUT_GROUP_PATH = SERVER_PATH + CHARACTERISTICS + CHARACTERISTICS_WITHOUT_GROUP

const CHARACTERISTIC_GROUPS = '/characteristic-groups'
export const CHARACTERISTIC_GROUPS_PATH = SERVER_PATH + CHARACTERISTIC_GROUPS

const CHARACTERISTIC_SETS = '/characteristic-sets'
export const CHARACTERISTIC_SETS_PATH = SERVER_PATH + CHARACTERISTIC_SETS

export const CONTACTS_PATH = SERVER_PATH + '/contacts'
