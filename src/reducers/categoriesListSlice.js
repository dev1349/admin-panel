...
const transferSubcategory = (
    ...
    const currentIndex =
        currentCategory.subcategories.indexOf(currentSubcategory)
...
export const getCategories =
    (categories, currentCategory, category) => dispatch => {
        let res = transferCategory(
            categories,
...
export const getSubcategories =
    (categories, currentCategory, currentSubcategory, subcategory) =>
    dispatch => {
        let res = transferSubcategory(
            categories,
            currentCategory,
            currentSubcategory,
            subcategory
